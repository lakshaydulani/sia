    ...
    <WidgetCard
      ...
      description={
        <>
          <Badge
            renderAsDot
            className="me-0.5 bg-[#7c88b2] dark:bg-[#7c88b2]"
          />{' '}
          Sales
          <Badge renderAsDot className="me-0.5 ms-4 bg-[#5a5fd7]" /> Bookings
          <Badge renderAsDot className="me-0.5 ms-4 bg-[#8200E9]" /> Enquiries
        </>
      }
