...
const analyticsStatData = [
  ...
  },
  {
    ...
    title: 'Enquiries',
    metric: '12.56%',
    info: 'Number of enquiries received across all channels.',
    increased: false,
    decreased: true,
    percentage: '-4.40',
    fill: '#048848',
  ...
  },
  {
    ...
    title: 'Bookings',
    metric: '45.33%',
    info: 'Number of bookings received.',
    increased: true,
    decreased: false,
    percentage: '+32.40',
    fill: '#B92E5D',
  ...
  },
  {
    ...
    title: 'Cancellations',
    metric: '2,300',
    info: 'Number of cancellations against bookings.',
    increased: true,
    decreased: false,
    percentage: '+2.40',
    fill: '#8200E9',
    ...
    >
      {analyticsStatData.map((stat) => (
        <MetricCard
          ...
          info={
            <Text className="mt-4 max-w-[150px] text-xs text-gray-500">
              {stat.info}
            </Text>
          }
          chart={
