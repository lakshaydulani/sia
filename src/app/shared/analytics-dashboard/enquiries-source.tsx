...
const data = [
  { name: 'Offline', value: 2560 },
  { name: 'Online', value: 2150 },
  { name: 'Events', value: 2780 },
  { name: 'Others', value: 2000 },
];
const COLORS = ['#B92E5D', '#6D1A36', '#D68585', '#FFD1D1'];

export default function EnquiriesSource({
  className,
}: {
  className?: string;
}) {
  return (
    <WidgetCard title={'Enquiries Source'} rounded="lg" className={className}>
