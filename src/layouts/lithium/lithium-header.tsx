...
export default function Header() {
  ...
  return (
    <header
      className={
        'sticky top-0 z-50 flex items-center justify-between bg-primary px-4 py-4 backdrop-blur-xl dark:bg-gray-50/50 md:px-5 lg:px-6 2xl:py-5 2xl:pl-6 3xl:px-8'
      }
      // className={cn(
      //   'sticky top-0 z-50 flex items-center justify-between bg-primary px-4 py-4 backdrop-blur-xl dark:bg-gray-50/50 md:px-5 lg:px-6 2xl:py-5 2xl:pl-6 3xl:px-8',
    ...
    >
      <div className="hidden items-center gap-3 xl:flex">
        <Link
          ...
          href={'/'}
          // w-[215px] 
          // className="me-4 hidden shrink-0 text-gray-900 lg:me-5 xl:block"
        >
          <Image
            src={siteConfig.logo}
